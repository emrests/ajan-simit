...
const SECTIONS: SectionInfo[] = [
  ...
  },
  {
    key: 'quickTask',
    icon: '⚡',
    titleKey: 'help.quickTask.title',
    content: {
      tr: [
        'Hizli Gorev, proje olusturmadan dogrudan ajanlara gorev gondermenizi saglar.',
        'Sidebar\'daki "⚡ Hizli Gorev" butonuyla acilir.',
        '',
        'Temel Kullanim:',
        '1. Sol panelden bir ajan secin veya "Tum Ajanlar" secenegini kullanin.',
        '2. Calisma dizinini girin (projenizin bulundugu klasor yolu).',
        '3. Gorev aciklamasini yazin.',
        '4. "Baslat" butonuna tiklayin veya Enter tusuna basin.',
        '',
        'Tek Ajan Modu:',
        '- Belirli bir ajani sectiginizde gorev sadece o ajana gonderilir.',
        '- Ajanin durumu (idle/thinking/typing) listede gosterilir.',
        '',
        'Tum Ajanlar Modu:',
        '- "Tum Ajanlar" secildiginde tum idle (bosta) ajanlar gorevi alir.',
        '- Mesgul ajanlar atlanir.',
        '- Kac ajanin basariyla baslatildigi sonuc olarak gosterilir.',
        '',
        'PM Koordinasyonu:',
        '- Ofiste PM olarak isaretlenmis bir ajan varsa ve "Tum Ajanlar" secildiyse:',
        '- Gorev once PM ajanina gonderilir.',
        '- PM gorevi analiz eder ve alt gorevlere boler.',
        '- Her alt gorev uygun ajana dagitilir (ajan yeteneklerine gore).',
        '- Ajanlar kendi ozel gorevlerini alir, ayni gorevi herkes almaz.',
        '',
        'PM Atama:',
        '- Ajan karti > Profil > "Proje Yoneticisi (PM)" toggle\'ini acin.',
        '- PM olan ajanlar listede mavi "PM" etiketi ile gosterilir.',
        '- PM yoksa tum ajanlara ayni gorev gonderilir.',
        '',
        'Calisma Dizini:',
        '- Calisma dizini ofis bazinda kaydedilebilir ("Kaydet" butonu).',
        '- Bir kez kaydedildiginde her hizli gorevde otomatik doldurulur.',
        '',
        'Son Gorevler:',
        '- Panel altinda son 8 gorevin ozeti gosterilir.',
        '- Ajan adi, baslangic saati, token kullanimi, sure ve maliyet bilgisi.',
      ],
      en: [
        'Quick Task lets you send tasks directly to agents without creating a project.',
        'Open it with the "⚡ Quick Task" button in the sidebar.',
        '',
        'Basic Usage:',
        '1. Select an agent from the left panel or use "All Agents".',
        '2. Enter the working directory (the folder path of your project).',
        '3. Write the task description.',
        '4. Click "Start" or press Enter.',
        '',
        'Single Agent Mode:',
        '- When a specific agent is selected, the task is sent only to that agent.',
        '- The agent\'s status (idle/thinking/typing) is shown in the list.',
        '',
        'All Agents Mode:',
        '- When "All Agents" is selected, all idle agents receive the task.',
        '- Busy agents are skipped.',
        '- The number of successfully started agents is shown as a result.',
        '',
        'PM Coordination:',
        '- If an agent marked as PM exists and "All Agents" is selected:',
        '- The task is first sent to the PM agent.',
        '- PM analyzes the task and breaks it into subtasks.',
        '- Each subtask is distributed to the appropriate agent (based on capabilities).',
        '- Agents receive their own specific tasks, not everyone gets the same task.',
        '',
        'Setting PM:',
        '- Agent card > Profile > Toggle "Project Manager (PM)" on.',
        '- PM agents show a blue "PM" badge in the list.',
        '- Without a PM, the same task is sent to all agents.',
        '',
        'Working Directory:',
        '- The working directory can be saved per office ("Save" button).',
        '- Once saved, it auto-fills for every quick task.',
        '',
        'Recent Tasks:',
        '- The last 8 tasks are summarized at the bottom of the panel.',
        '- Agent name, start time, token usage, duration, and cost info.',
      ],
    },
  },
  {
  ...
  },
  {
    key: 'training',
    icon: '🎓',
    titleKey: 'help.training.title',
    content: {
      tr: [
        'Egitim sistemi, ajanlara proje veya teknoloji bazinda uzmanlik kazandirmanizi saglar.',
        '',
        'Egitim Modlari:',
        '- Proje Analizi: Claude, belirtilen proje dizinini analiz ederek egitim dokumani olusturur.',
        '- Teknoloji Egitimi: Claude, belirtilen teknoloji hakkinda kapsamli egitim dokumani olusturur.',
        '',
        'Egitim Profili Olusturma:',
        '1. Sidebar > "🎓 Ajan Egitimi" butonuna tiklayin.',
        '2. Yeni profil olusturun (mod + aciklama + istege bagli kullanici prompt\'u).',
        '3. "Egitimi Baslat" butonuyla Claude analiz yaparak dokuman uretir.',
        '4. Olusan profili ajana atayin (Ajan > 🎓 Egitim sekmesi).',
        '',
        'Enjeksiyon:',
        '- Egitim profili atanan ajan, her oturum basinda egitim icerigini otomatik alir.',
        '- Enjeksiyon sirasi: Sistem Prompt > Egitim > Skills > Gorev.',
        '',
        'Sifirlama:',
        '- Egitim takilirsa "Sifirla" butonu ile durumu temizleyebilirsiniz.',
      ],
      en: [
        'The training system lets you give agents project-based or technology-based expertise.',
        '',
        'Training Modes:',
        '- Project Analysis: Claude analyzes the specified project directory and creates a training document.',
        '- Technology Training: Claude creates a comprehensive training document about the specified technology.',
        '',
        'Creating a Training Profile:',
        '1. Sidebar > Click the "🎓 Agent Training" button.',
        '2. Create a new profile (mode + description + optional user prompt).',
        '3. Click "Start Training" — Claude analyzes and generates the document.',
        '4. Assign the profile to an agent (Agent > 🎓 Training tab).',
        '',
        'Injection:',
        '- An agent with an assigned training profile automatically receives the training content at every session start.',
        '- Injection order: System Prompt > Training > Skills > Task.',
        '',
        'Reset:',
        '- If training gets stuck, use the "Reset" button to clear the status.',
      ],
    },
  },
  {
